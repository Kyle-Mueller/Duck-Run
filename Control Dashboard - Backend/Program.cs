...
var dashboardOpts = builder.Configuration
...
builder.Services.AddDbContextFactory<DashboardDbContext>(opts =>
    ProviderConfigurator.Configure(opts, dashboardOpts.Db.Provider, dashboardOpts.Db.ConnectionString));
